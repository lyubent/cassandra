...
{
    private static final String KEYSPACE = "CounterMutationTest";
    ...
    public static void defineSchema() throws ConfigurationException
    {
        ...
        schema.add(KSMetaData.testMetadata(KEYSPACE,
                                           ...
                                           SchemaLoader.standardCFMD(KEYSPACE, CF1).defaultValidator(CounterColumnType.instance),
                                           SchemaLoader.standardCFMD(KEYSPACE, CF2).defaultValidator(CounterColumnType.instance)));
    ...
    {
        ColumnFamilyStore cfs1 = Keyspace.open(KEYSPACE).getColumnFamilyStore(CF1);
        ColumnFamilyStore cfs2 = Keyspace.open(KEYSPACE).getColumnFamilyStore(CF2);
        ...
        Mutation mutation = new Mutation(KEYSPACE, bytes(1));
        mutation.add(cells1);
        mutation.add(cells2);
