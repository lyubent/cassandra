...
{
    public static final String KEYSPACE = "OneCompactionTest";
    ...
    public static void defineSchema() throws ConfigurationException
    {
        ...
        schema.add(KSMetaData.testMetadata(KEYSPACE,
                                           ...
                                           SchemaLoader.standardCFMD(KEYSPACE, CF_STANDARD1).compactionStrategyOptions(leveledOptions),
