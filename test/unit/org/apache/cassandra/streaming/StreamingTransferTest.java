...
public class StreamingTransferTest
{
    ...
    {
        final Keyspace keyspace = Keyspace.open(KEYSPACE1);
        final ColumnFamilyStore cfs = keyspace.getColumnFamilyStore(CF_COUNTER);
    ...
    public void testTransferTableMultiple() throws Exception
    {
        ...
        content.add("test2");
        content.add("test3");
        SSTableReader sstable = SSTableUtils.prepare().write(KEYSPACE1, content);
        ...
        SSTableReader sstable2 = SSTableUtils.prepare().write(KEYSPACE1, content);
        ...
        assert cfstore.getColumnFamily(QueryFilter.getIdentityFilter(Util.dk("transfer1"), CF_STANDARD, System.currentTimeMillis())) == null;
        assert cfstore.getColumnFamily(QueryFilter.getIdentityFilter(Util.dk("transfer2"), CF_STANDARD, System.currentTimeMillis())) == null;
        assert cfstore.getColumnFamily(QueryFilter.getIdentityFilter(Util.dk("test2"), CF_STANDARD, System.currentTimeMillis())) == null;
        assert cfstore.getColumnFamily(QueryFilter.getIdentityFilter(Util.dk("test3"), CF_STANDARD, System.currentTimeMillis())) == null;
    }
    ...
    public void testTransferOfMultipleColumnFamilies() throws Exception
    {
        ...
        IPartitioner p = StorageService.getPartitioner();
        String[] columnFamilies = new String[] { CF_STANDARD, CF_STANDARD2, CF_STANDARD3 };
